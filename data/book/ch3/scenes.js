...
const SCENES = [
{
  ...
  { look:{ val:true },
    ...
    fact:[['storage/innobase/include/data0type.h','constexpr size_t DATA_TRX_ID_LEN = 6;'],
          ['storage/innobase/include/data0type.h','constexpr size_t DATA_ROLL_PTR_LEN = 7;'],
...
},
{
  ...
  { look:{ val:true },
    ...
    fact:[['storage/innobase/include/data0type.h','constexpr size_t DATA_ROLL_PTR_LEN = 7;'],
...
},
{
  ...
  { look:{ dir:true },
    ...
    key:'같은 페이지 안에서 <em>두 방향으로 자라는 두 영역</em>이 공간을 나눠 쓴다. "얼마나 남았나" 를 한 뺄셈으로 알 수 있고, 09 장면의 조각화도 이 구조 위에서 이야기된다.',
  ...
  { look:{ pg:true, op:true },
    ...
    fact:[['storage/innobase/include/page0page.h','constexpr uint32_t PAGE_DIR_SLOT_SIZE = 2;'],
          ...
          ['storage/innobase/include/page0page.h','constexpr uint32_t PAGE_DIR_SLOT_MAX_N_OWNED = 8;']],
    beat:1 },
  ],
},
{
